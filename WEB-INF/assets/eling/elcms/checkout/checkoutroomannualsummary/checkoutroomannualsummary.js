...
define(function(require, exports, module) {
	...
	var checkoutroomannualsummary = ELView.extend({
		attrs:{
		...
		initComponent:function(params,widget){
			...
			var grid=new ReportGrid({
				...
				model:{
					datas : {
						...
						click : function(data){
								...
								widget.openView({
									url:"eling/elcms/checkout/checkoutroom/checkoutroomapproval/checkoutroomapproval",
									params:{
										start : start,
										end : end,
										...
										father:"checkoutroomannualsummary"
									},
									isAllowBack:true
									});
						}
				...
				parentNode:".J-list",
				url:"api/checkoutroomapply/checkoutroomannualsummary",
				params:function(){
					return {
	...
	module.exports = checkoutroomannualsummary;
});