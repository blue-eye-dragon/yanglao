define(function(require, exports, module) {
	...
	var furnshingSituation = BaseView.extend({
					...
					search : function(str) {
						...
						aw.ajax({
							...
							data:{
								...
								"memberSigning.room.pkRoom,checkInFurinshing.situation,checkInFurinshing.situationConfirmUser.name," +
								"checkInFurinshing.situationConfirmDate,checkInFurinshing.situationStatus,checkInFurinshing.version," +
								"checkInFurinshing.pkCIFurnishing,status.value,checkInFurinshing.status"
							},
							dataType:"json",
			...
			return {
				...
				model:{
					columns:[{
						...
						key:"checkInFurinshing.situationConfirmUser.name",
						name:"确认人"
					},{
						key:"checkInFurinshing.situationConfirmDate",
						name:"确认时间",
						format : "date",
						formatparams:{
						...
						name:"入住资产状态",
						format:function(value,row){
							return value=row.checkInFurinshing.status.key=="Pended"?"未确认":"已确认"
						}
					},{
						key:"operate",
						name:"操作",
						...
						formatparams:[{
							...
							show:function(data,row){
								if(row.status.key=="Doing" && row.checkInFurinshing.status.key=="Pended"){
									return true;
								}else{
									return false;
								}
	...
	module.exports = furnshingSituation;
});