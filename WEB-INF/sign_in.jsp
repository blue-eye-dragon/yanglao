  ...
  <body>
	  					...
	  					<div class="login-container">
	       					<form action="<c:url value="/j_spring_security_check"/>" class='validate-form' method='post'>
	          					...
	          					<div class="form-group">
	           					...
	           					<button id='j_btn_submite'  type="button" class='loginBtn btn btn-block btn-danger'>登 录</button>
								<button  id='j_btn_submite_hidden' type="submit" style="display: none;" class='loginBtn btn btn-block btn-danger'></button>
		...
		<script type="text/javascript">
			seajs.use(['$', 'store'], function($, store) {
			   ...
			   // --重新定义提交按钮的操作
			    $("#j_btn_submite").click(function(e) {
					// 请求微服务登录模块
