...
(function (factory) {
	...
	if(typeof define === 'function' && define.cmd){
		define("jquery-ui-timepicker-addon",['$', 'jquery.ui'], function(require,exports,module){
			factory(jQuery);
		});
	}else {
		factory(jQuery);
	...
	$.fn.extend({
		...
		timepicker: function (o) {
			...
			return $(this).each(function () {
				//lixiaochen修改，为了与Date组件中的datetimepicker保持区别
				$.fn.datetimepicker1.apply($(this), tmp_args);
			});
		},
