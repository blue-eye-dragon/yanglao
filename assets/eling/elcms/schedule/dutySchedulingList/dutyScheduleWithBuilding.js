define(function(require, exports, module) {
	...
	var DutyScheduleWithBuildingConfirm = ElView.extend({
        ...
        events:{
        	"click .J-grid-table-dutydate":function(e){
        		...
        		if(editable){
    				...
    				if(end.isBefore(moment())||moment().add('day',-1).isAfter(moment(datas[a].userdutylist[b].dutylist[c].dutyDate))){
    					Dialog.alert({
	...
	module.exports = DutyScheduleWithBuildingConfirm;
});