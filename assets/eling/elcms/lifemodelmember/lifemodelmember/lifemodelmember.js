				...
				model : {
					...
					items : [{
						...
						handler:function(){
							...
							// widget.get("subnav").hide(["search","update","trajectory"]).show(["return","save"]);
							// $(".J-wizard .J-button-area").addClass("hidden");

                            if(pklifemodelmember !=null){
                                aw.ajax({
                                    url : "api/lifemodelmember/query",
                                    data : {
                                        pkLifeModelMember:pklifemodelmember,
                                    ...
                                    success : function(data){
                                        ...
                                        widget.get("wizard").first();
                                        // 先注释  图片编辑问题
                                        //profile.loadPicture("https://szeling-master.oss-cn-shenzhen.aliyuncs.com/qinheyuan/"+data[0].member.personalInfo.pkPersonalInfo);
								...
								if(data.pkLifeModelMember !=null){
									aw.ajax({
										...
										success : function(data){
											...
											if(data[0].lifeMember.consumptionCiew != null){
												...
												}else if(data[0].lifeMember.consumptionCiew.key == 'Conservative'){
													data[0].consumptionCiew = data[0].lifeMember.consumptionCiew.value;
												}else{
                                                    data[0]._consumptionCiew = data[0].lifeMember.consumptionCiew.value;
												}
											}
											...
											if(data[0].healthyMember.osteoporosis != null){
												if(data[0].healthyMember.osteoporosis.key == "NoOsteoporosis"){
													data[0].osteoporosis = "";
												}else if(data[0].healthyMember.osteoporosis.key == 'SevereOsteoporosis'){
													data[0].osteoporosis = data[0].healthyMember.osteoporosis.value;
												}else{
                                                    data[0]._osteoporosis = data[0].healthyMember.osteoporosis.value;
												}
											}
											if(data[0].healthyMember.diabetes != null){
												if(data[0].healthyMember.diabetes.key == "NoDiabetes"){
													data[0].diabetes = "";
												}else if(data[0].healthyMember.diabetes.key == 'Mellitus'){
													data[0].diabetes = data[0].healthyMember.diabetes.value;
												}else{
                                                    data[0]._diabetes = data[0].healthyMember.diabetes.value;
												}
											}
											if(data[0].healthyMember.tumour != null){
												if(data[0].healthyMember.tumour.key == "NoTumour"){
													data[0].tumour = "";
												}else if(data[0].healthyMember.tumour.key == 'MiddleLaterPeriod'){
													data[0].tumour = data[0].healthyMember.tumour.value;
												}else{
                                                    data[0]._tumour = data[0].healthyMember.tumour.value;
												}
											}
											...
											if(data[0].healthyMember.heartDisease != null){
												if(data[0].healthyMember.heartDisease.key == "Normal"){
													data[0].heartDisease = "";
												}else if(data[0].healthyMember.heartDisease.key == 'Depressed'){
													data[0].heartDisease = data[0].healthyMember.heartDisease.value;
												}else{
                                                    data[0]._heartDisease = data[0].healthyMember.heartDisease.value;
												}
											}
									...
									aw.ajax({
										...
										success : function(data){
											...
											widget.get("wizard").first();
                                            // 先注释  图片编辑问题
                                            // profile.loadPicture("https://szeling-master.oss-cn-shenzhen.aliyuncs.com/qinheyuan/"+data[0].personalInfo.pkPersonalInfo);
