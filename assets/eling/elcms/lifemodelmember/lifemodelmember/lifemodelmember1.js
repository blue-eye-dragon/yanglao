define(function(require, exports, module){
	...
	var lifemodelmember = ELView.extend({
        ...
        afterInitComponent:function(params,widget){
			if(params && params.param == 'lifemodel'){
				var pk = null;
                aw.ajax({
				...
				if(pk != null){
                    aw.ajax({
                        ...
                        success : function(data){
                            ...
                            //年龄
                            var returnAge;
                            var strBirthdayArr=data[0].member.personalInfo.birthdayString.split("-");
                            var birthYear = strBirthdayArr[0];
                            var birthMonth = strBirthdayArr[1];
                            var birthDay = strBirthdayArr[2];
                            d = new Date();
                    ...
                    aw.ajax({
                        ...
                        success : function(data){
                            ...
                            //年龄
                            var returnAge;
                            var strBirthdayArr=data[0].personalInfo.birthdayString.split("-");
                            var birthYear = strBirthdayArr[0];
                            var birthMonth = strBirthdayArr[1];
                            var birthDay = strBirthdayArr[2];
                            d = new Date();
