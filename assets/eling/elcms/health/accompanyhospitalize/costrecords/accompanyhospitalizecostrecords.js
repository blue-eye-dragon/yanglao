define(function(require, exports, module) {
	...
	require("../application/accompanyhospitalize.css"); 
	var template=require("../application/accompanyhospitalize.tpl");
	//多语
					...
					columns:[{
						...
						formatparams:[{
							...
							handler:function(index,data,rowEle){
								...
								$(".el-health-accompanyhospitalize").addClass("editform").removeClass("main");
								return false;
							}
						}]
					},{
